  ...
  return (
    ...
    >
      ...
      <div className="p-4 flex flex-col items-center bg-opacity-90 rounded-lg w-full">
        ...
        <h2
          className="text-lg absolute bottom-8 text-black rounded-2xl px-2 bg-white bg-opacity-20 [text-shadow:_0px_0px_3px_rgb(255_255_255)] dark:[text-shadow:_0px_0px_3px_rgb(0_0_0)] dark:text-white dark:shadow-stone-950 mb-2 truncate"
          aria-label={`Music title: ${music.name}`}
        >
          {music.name}
        </h2>
